...
//	vector<DMatch> DoMatching_Fixed(Mat& image1, Mat& image2, int &nNumKeypoint1, int &nNumKeypoint2);
	vector<DMatch> DoMatching_Fixed(Mat& image1, Mat& image2, int &nNumKeypoint1, int &nNumKeypoint2, float &fEuDistRatio, float &fAvgFeatureRatio, float &fMaxFeatureRatio);
