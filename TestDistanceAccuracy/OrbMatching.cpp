...
vector<DMatch> OrbMatching::DoMatching_Fixed(Mat& image1, Mat& image2, int &nNumKeypoint1, int &nNumKeypoint2, float &fEuDistRatio, float &fAvgFeatureRatio, float &fMaxFeatureRatio)
{
	vector<KeyPoint> keypoints1, keypoints2;
	Mat descriptors1, descriptors2;
	vector<DMatch> matches;

	OrbFeatureDetector detector(1000, 1.1, 10); 
